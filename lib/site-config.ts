...
export const siteConfig = {
  ...
  certificate: {
    validity: {
      ...
      promotionNote:
        "Строк дії сертифіката — 6 місяців з дати оплати. Не забудьте записатися на сеанс завчасно, щоб гарантувати зручний для вас час.",
    },
  },
  ...
  successPage: {
    ...
    steps: [
      ...
      {
        number: 2,
        text: "Ви отримаєте всю необхідну інформацію про активацію вашого сертифіката.",
      },
      {
        number: 3,
